...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'user') { // Adjusted role check to 'user'
...
$userQuery = $conn->query("SELECT fullname FROM users WHERE id = $userId");
$userRow = $userQuery->fetch_assoc();
$fullName = $userRow['fullname'];

// Get recent inventory and reports (removed office_id condition)
$recentInventoryQuery = $conn->query("SELECT * FROM assets ORDER BY last_updated DESC LIMIT 5");
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-9 col-xl-10 col-sm-9 dashboard-right p-4">
